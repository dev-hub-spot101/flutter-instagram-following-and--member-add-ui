...
import 'package:followerandmenberui/models/user.dart';
import 'package:followerandmenberui/pages/members.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
              ...
              child: Text("Members", style: TextStyle(color: Colors.black)))
        ],
      ),
      body: Container(
